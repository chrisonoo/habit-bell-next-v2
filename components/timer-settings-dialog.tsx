  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button variant="ghost" size="icon" className="absolute top-4 left-4 z-10 h-12 w-12">
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>Configure your session and interval durations for the Habit Bell timer.</DialogDescription>
        </DialogHeader>
